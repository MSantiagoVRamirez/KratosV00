...
export const Step4: FC<Props> = ({data, updateData}) => {
  const onFile = (file: File | null) => {
    const preview = file ? URL.createObjectURL(file) : null
    updateData({step4: {...data.step4, imagenFile: file, imagenPreview: preview}})
  }
          ...
          <div className='row'>
            <div className='col-md-6'>
              <div className='fv-row mb-7'>
                ...
                {data.step4?.imagenPreview && (
                  <img src={data.step4.imagenPreview || ''} alt='preview' style={{maxWidth: 180, marginTop: 10, borderRadius: 8}} />
                )}
              </div>
            </div>
            <div className='col-md-6'>
              <div className='alert alert-primary'>
                ...
                <div><strong>Tipo:</strong> {data.tipoUsuario || '-'}</div>
              </div>
            </div>
          </div>
        </div>
