...
function RegistroEmpresa({ onClose, onSuccess }: RegistroEmpresaProps) {
    ...
    useEffect(() => {
        ...
        fetch('https://localhost:7221/api/ConsultasRegistro/ListaActivdad')
        ...
        fetch('https://localhost:7221/api/ConsultasRegistro/ListaTipoSociedad')
            .then(response => response.json())
            .then(data => {
        ...
        fetch('https://localhost:7221/api/ConsultasRegistro/ListaRegimenTributario')
            .then(response => response.json())
            .then(data => {
                setRegimenes(data);
    ...
    return (
        <div style={{ margin: '2% 10%' }}>
            <div style={{ height: '500%' }}>
                <h2 style={{ fontSize: '2.5rem' }}>Registro como Usuario</h2>
                <form style={{ margin: '0% 0%' }} onSubmit={handleSubmit} className="form-flex">
                    ...
                    <fieldset style={{ border: '1px solid #ccc', borderRadius: '8px', marginBottom: '1.5em', padding: '1em' }}>
                        <legend style={{ fontWeight: 'bold', color: 'rgb(255, 255, 255)', fontSize: '2rem' }}>Acceso</legend>
